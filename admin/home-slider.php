          ...
          <table class="min-w-full divide-y divide-gray-200 table-fixed">
            ...
            ?>
              <tr class="hover:bg-gray-100">
                ...
                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"><?php echo $data['title'] ?>
                </td>
                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"><?php echo $data['btn1'] ?>
                </td>
