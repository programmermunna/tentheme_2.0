          ...
          <div style="display:flex;justify-content:space-between">
            <div style="display:flex">
              <a style="margin:15px;display:block;text-align:center;padding-top:12px;" class="input"
                href="investors.php">Refresh <i class="fa-solid fa-rotate-right"></i></a>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"><?php echo $data['name'] ?>
                  </td>
                  <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                  ...
                  <td class="p-4 text-sm font-bold text-green-500 whitespace-nowrap lg:p-5">
                    <?php echo $data['investor'] ?></td>
                  <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                    <a href="investors.php?action=Accepted&&id=<?php echo $data['id'] ?>"
                      class="popup_show btn bg-red-500 w-fit text-white" style="background:#4ade80;">Accept</a>
                    <a href="investors.php?action=Rejected&&id=<?php echo $data['id'] ?>"
                      class="popup_show btn bg-red-500 w-fit text-white">Reject</a>
                    <a href="investors.php?action=&&id=<?php echo $data['id'] ?>"
                      class="popup_show btn bg-red-500 w-fit text-white" style="background:#4ade80;">Delete</a>
                  </td>
                </tr>
                <?php }?>
