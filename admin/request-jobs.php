                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Contact
                      </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100">
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 4 </td>
                      ...
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 01791717171 </td>

                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <button data-target="reject_product" type="button"
                          class="popup_show btn bg-red-500 w-fit text-white">Reject</button>
                        <button data-target="approve_product" type="button"
