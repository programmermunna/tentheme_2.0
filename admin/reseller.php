          ...
          <div style="display:flex;justify-content:space-between">
            <div style="display:flex">
              <a style="margin:15px;display:block;text-align:center;padding-top:12px;" class="input"
                href="reseller.php">Refresh <i class="fa-solid fa-rotate-right"></i></a>
            </div>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                    <a id="add_bank" href="reseller.php?action=Accepted&&id=<?php echo $data['id'] ?>"
                      class="popup_show btn bg-red-500 w-fit text-white" style="background:#4ade80;">Accept</a>
                    <a href="reseller.php?action=Rejected&&id=<?php echo $data['id'] ?>"
                      class="popup_show btn bg-red-500 w-fit text-white">Reject</a>
                    <a id="add_bank" href="reseller.php?action=&&id=<?php echo $data['id'] ?>"
