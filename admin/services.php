          ...
          <div style="display:flex;justify-content:space-between">
            <div style="display:flex">
              <a style="width:200px;margin:15px;display:block;text-align:center;padding-top:12px;" class="input"
                href="services.php"><i class="fa-solid fa-rotate-right"></i> Refresh</a>
              <a style="margin:15px;display:block;text-align:center;padding-top:12px;background:#0e33f7;color:#ffff"
                class="input" href="add-service.php">Add Service</a>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <?php
                  if (isset($_GET['src'])) {
                      $src = trim($_GET['src']);
                      $service = _get("service", "id!='' AND (title LIKE '%$src%' OR regular_price='$src' OR sell_price='$src' OR category='$src')");
