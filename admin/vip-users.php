                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100">
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 1 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> bsoftware </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> bsoftware@xo.com </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> Bangladesh </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 46,454.50 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> Admin </td>
                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <a href="./edit-user.php" type="button" class="btn bg-green-600 w-fit text-white">Edit</a>
                        <button data-target="delete_user" type="button"
