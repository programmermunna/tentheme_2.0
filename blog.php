...
<div class="container space-y-6 pt-12">
  <!-- Page name Title -->
  <h3 class="text-[40px] font-normal tracking-wide"><?php echo $data['title'] ?></h3>
          ...
          <div class="pt-6 space-y-3">
            <div class="border rounded overflow-hidden">
              ...
              <div class="pl-8 pr-4 py-4">
                <div class="overflow-hidden flex items-center justify-between">
                  <a href="#" class="flex items-center gap-x-3 text-blue-500 font-medium">
                    <img class="w-10 h-10 object-contain rounded-full" src="https://i.ibb.co/Ryr9PQB/index.jpg" alt="">
                    <span>Steve</span>
                  </a>
                  <small>1 month ago</small>
                </div>
