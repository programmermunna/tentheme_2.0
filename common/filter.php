<div class="flex justify-between items-center">
  ...
  <div class="flex items-center  gap-x-4">
    <button data-view="list_view" class="items_view_handler active_view text-gray-500 hover:text-black text-xl">
...
if (isset($_GET['sort'])) {
    ...
    echo "Default";
          ...
          <ul id="filter_list2">
            <li><a href="<?php echo $cr_url; ?>?sort=ASC">Price: Low < High</a>
            </li>
            <li><a href="<?php echo $cr_url; ?>?sort=DESC">Price: High > Low</a></li>
          </ul>
        </li>
      </ul>
    </div>
