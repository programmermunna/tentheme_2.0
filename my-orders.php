...
<div class="container space-y-6 pt-6 pb-12 lg:py-24">
  ...
  <div class="items-center justify-start space-x-2 text-gray-500">
    ...
    <a style="background-image: conic-gradient(from 1turn, #0e9479, #16a085)"
      class="text-white px-4 py-1.5 rounded shadow-sm" href="my-orders.php">My Orders
    </a>
  ...
  <div class="flex items-start py-16">
    <div class="container flex flex-col lg:flex-row gap-y-5 lg:gap-y-0 lg:gap-x-5">
      ...
      <div class="w-full bg-white shadow rounded-sm overflow-hidden">
        ...
        <div class="px-5 py-4 text-blue-600 text-2xl font-medium tracking-wide border-b">All Orders</div>
                ...
                <table>
                  <thead class="border-b">
                    <tr>
                      ...
                      <th scope="col" class="text-base font-semibold text-gray-900  px-6 py-4 text-left">Payment Method</th>
                      <th scope="col" class="text-base font-semibold text-gray-900  px-6 py-4 text-left">Transection Id</th>
                      ...
                      <th scope="col" class="text-base font-semibold text-gray-900  px-6 py-4 text-left">Status</th>
                  ...
                  <tbody>
                    ...
                    $next_page = $page_no + 1;
                    $adjacents = "2";
                    $orders = _get("orders", "pid=$id ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                    $total_records = mysqli_num_rows(_get("orders", "pid=$id"));
                    ...
                    <tr class="border-b">                   
                      ...
                      <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                        <?php echo $data['pmn_transection'];?>
                      </td>
                      <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                        <?php $time = $data['time']; echo date("d-M-y", $time);?>
                      </td>
                      <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                        $<?php echo $data['pmn_amount'] ?>
                      </td>
                      ...
                      <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"><a
                          target="" href="order-view.php?order_id=<?php echo $data['order_id'] ?>"
